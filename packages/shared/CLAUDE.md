...
The contracts every layer agrees on. Pure types + the plugin API. No runtime
logic, no I/O, no DOM, no Node APIs — anything imported here must work in
browser, Node, and Electron main equally.

...
|---|---|
| Browser tab | Your browser's own private storage by default — a real SQLite database, kept on your device. Nothing leaves it unless you turn on sync. |
...
You can change your mind later: press **Save** on a browser workspace and it goes
into a file from then on.
